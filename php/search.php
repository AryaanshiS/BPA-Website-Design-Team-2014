...
echo "    <tr>";
echo "        <td><p>";
echo             $firstDepartureTime;
echo "        <br>";
echo             $airportNearLocationCity;
echo "         - ";
echo            $airportNearLocationCallsign;
echo "        </p></td>";
echo "        <td>&#8594;</td>";
echo "        <td>";
echo            $firstArrivalTime;
echo "        <br>";
echo             $airportNearDestinationCity;
echo "         - ";
echo            $airportNearDestinationCallsign;
echo "        </td>";
echo "        <td>Time<br>";
echo            $hoursOfFlight;
echo "        </td>";
echo "        <td>";
echo             $departureAirlineName;
echo            $departureFlightNumber;
echo "        </td>";
echo "    </tr>";
echo "    <tr>";
...
echo "        </td>";
echo "        <td>";
echo             $destinationAirlineName;
echo              $returnFlightNumber;
echo "        </td>";
echo "    </tr>";
echo " </table>";
}
